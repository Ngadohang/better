...
module.exports={
    ...
    pressKey: async(page,location,value,numberDelay)=>{
        try {
            await page.waitForSelector(page,location);
            await page.focus(location);
            await page.keyboard.press(value,{delay:numberDelay});
        } catch (error) {
           console.log(error.message);
        }
    },
    downKey: async(page,location,value)=>{
        try {
    ...
    upKey: async(page,location,value)=>{
        try {
    ...
    getAttributeElement: async(page,location,value)=>{
        try {
            await page.waitForSelector(location);
    ...
    //select dropdown custom/multilcustom
...
//Sort: const list= document.querrySelector("");
//
Sort: async()=>{
